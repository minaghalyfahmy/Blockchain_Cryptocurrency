...
class CurrencyConverter extends EventEmitter {
    static calculateRates(usdPrices) {
        ...
        for (let i in usdPrices.rates) {
            let o = usdPrices.rates[i];
    ...
    constructor(coin2USD) {
        super();
        this.rates = this.constructor.calculateRates(coin2USD);
        ...
        this.on(UPDATE, (o) => {
            ...
            this.rates[`USD-${sym}`] = 1 / usdPrice;
            this.rates[`${sym}-USD`] = usdPrice;
